module.exports = 
  owly: 
    input:  'The LinkedIn IPO: A Valuable Lesson for Entrepreneurs http://ow.ly/4YBFH'
    output: 'The LinkedIn IPO: A Valuable Lesson for Entrepreneurs http://blogs.forbes.com/tomtaulli/2011/05/19/the-linkedin-ipo-a-valuable-lesson-for-entrepreneurs/'
  bitly : 
  ...
  tco :
    input:  'Really interested to see what people think of the latest at http://t.co/dknrDCT - let me know! #epicmvp'
    output: 'Really interested to see what people think of the latest at http://epic.io - let me know! #epicmvp'